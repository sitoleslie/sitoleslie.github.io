...
function greeter(hour) {
    ...
    // check to see if the hour is between 0 & 11
  if (hour >= 0 && hour <= 11){
      // if true, log in Good morning
      console.log('Good Morning!')
      // check to see if hour is between 12 & 16
  }  else if (hour >= 12 && hour <= 16){
      // it will excute in the console Good Afternoon
      console.log('Good Afternoon!');
      // check to see if hour is between 17 & 21
  }else if (hour >= 17 && hour <= 21){
      // it will log 'Good Evening'
      console.log('Good Evening!');
  }  
  // default: 
  else {
      // if none of the above conditional statements are met it will run 'Good Night'
